...
def price1(Q, R, B,I, d):
    ...
    for i in range(5):
        QQ = np.copy(Q)
        user_ord = random.sample(range(100), 100)
...
dataset = generate_dataset(100, 7, 5, 3)
Q1, R1, B1, I1 = get_dataset(dataset, 100, 1)
Q2, R2, B2, I2 = get_dataset(dataset, 100, 2)
Q3, R3, B3, I3 = get_dataset(dataset, 100, 3)
Q4, R4, B4, I4 = get_dataset(dataset, 100, 4)
Q5, R5, B5, I5 = get_dataset(dataset, 100, 5)
...
payments5, total_utility5, Servers_utility5, users_utility5, winner_count5, docker_utilization5 = price1(Q5, R5, B5, I5,
                                                                                                         5)
# payments2,total_utility2, Servers_utility2, users_utility2, winner_count2=payments1,total_utility1, Servers_utility1, users_utility1, winner_count1
# payments3,total_utility3, Servers_utility3, users_utility3, winner_count3=payments1,total_utility1, Servers_utility1, users_utility1, winner_count1
# payments4,total_utility4, Servers_utility4, users_utility4, winner_count4=payments1,total_utility1, Servers_utility1, users_utility1, winner_count1
...
with open("data_d.txt", "w") as file:
